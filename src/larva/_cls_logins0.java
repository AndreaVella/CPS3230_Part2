...
try{
RunningClock.start();
pw = new PrintWriter("C:\\Users\\User\\workspace\\Test/src/output_logins.txt");
...
case 6: if (_mode == 0) return "unlockedPrematurely"; else return "!!!SYSTEM REACHED BAD STATE!!! unlockedPrematurely "+new _BadStateExceptionlogins().toString()+" ";
